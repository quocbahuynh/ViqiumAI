export default async function TeamPage() {
  return (
    <>
      <section className="hero overflow-hidden relative max-lg:pt-150 max-md:pt-32 pt-[240px] pb-[60px] max-md:pb-12 z-40">
        <div className="container">
          <div className="max-w-[948px] mx-auto text-center">
            <p className="mb-4 max-md:mb-3 font-medium uppercase max-md:text-sm">ĐỘI NGŨ PHÁT TRIỂN</p>
            <h1 className="max-lg:mb-10 max-md:mb-8 mb-10 max-md:text-3xl max-sm:text-2xl">
              Đội ngũ kiến tạo Viqium AI
            </h1>
            <p className="max-lg:mb-10 max-md:mb-8 mb-12 max-w-[590px] mx-auto max-md:text-sm max-md:px-4">
              Một đội ngũ trẻ, đầy nhiệt huyết và chuyên môn, không ngừng đổi mới để mang đến trải nghiệm AI tối ưu cho
              bạn.
            </p>
          </div>
        </div>
      ...
      <section className="bg-white dark:bg-dark-300 pb-[170px] max-md:pb-20 relative z-10">
        <div className="absolute left-1/2 -top-[200px] w-full h-[550px] -translate-x-1/2 bg-cover bg-hero-gradient bg-no-repeat bg-center opacity-70 md:hidden -z-10" />
        <div className="container">
          <div className="relative z-10">
            ...
            <div className="flex gap-8 max-lg:gap-6 max-md:gap-8 max-md:flex-col">
              {/* Team Member 1 - Huỳnh Bá Quốc */}
              <div className="group/image mt-6 max-md:mt-0 order-1 max-md:order-2 flex-1">
                <div className="bg-white dark:bg-dark-200 rounded-medium p-2.5 mb-6 max-md:mb-4">
                  <div className="rounded bg-gray-100 dark:bg-[#30302F] overflow-hidden">
                    <img
                      src="images/team/team1.png"
                      alt="team member image"
                      className="group-hover/image:grayscale-0 duration-300 transition-all w-full h-auto"
                    />
                  </div>
                </div>
                <div className="text-center">
                  <a href="team-single.html">
                    <h3 className="mb-2 max-md:text-lg">Huỳnh Bá Quốc</h3>
                  </a>
                  <p className="text-sm max-md:text-xs font-medium leading-[1.5] mb-6 max-md:mb-4">
                    Co-Founder & AI Solutions Architect
                  </p>
                  <ul className="flex items-center gap-x-2.5 max-md:gap-x-2 justify-center">
                    <li>
                      <a
                        href="#"
                        className="group duration-500 transition-colors hover:transition-colors hover:duration-500"
                      >
                        <svg
                          width={40}
                          height={40}
                          ...
                          className="fill-transparent group-hover:fill-primary duration-500 group-hover:duration-500 transition-colors group-hover:transition-colors max-md:w-8 max-md:h-8"
                        >
                          <rect
                            x="0.5"
                            y="0.5"
                          ...
                          <path
                            ...
                            fill="none"
                            className="fill-paragraph dark:fill-[#7D807B] dark:group-hover:fill-paragraph duration-500 group-hover:duration-500 transition-colors group-hover:transition-colors"
                          />
                        </svg>
                      </a>
                    </li>
              ...
              {/* Team Member 2 - Viễn Lê (Featured/Center) */}
              <div className="group/image order-2 max-md:order-1 flex-1">
                <div className="bg-white dark:bg-dark-200 rounded-medium p-2.5 mb-6 max-md:mb-4 md:min-w-[440px] max-md:min-w-0">
                  <div className="rounded bg-gray-100 dark:bg-[#30302F] overflow-hidden">
                    <img
                ...
                <div className="text-center">
                  <a href="team-single.html">
                    <h3 className="mb-2 max-md:text-lg">Viễn Lê</h3>
                  </a>
                  <p className="text-sm max-md:text-xs font-medium leading-[1.5] mb-6 max-md:mb-4">
                    Founder – Marketing & AI Strategist
                  </p>
                  <ul className="flex items-center gap-x-2.5 max-md:gap-x-2 justify-center">
                    <li>
                      <a
              ...
              {/* Team Member 3 - Đỗ Trần Tuấn Anh */}
              <div className="group/image mt-6 max-md:mt-0 order-3 flex-1">
                <div className="bg-white dark:bg-dark-200 rounded-medium p-2.5 mb-6 max-md:mb-4">
                  <div className="rounded bg-gray-100 dark:bg-[#30302F] overflow-hidden">
                    <img
                ...
                <div className="text-center">
                  <a href="team-single.html">
                    <h3 className="mb-2 max-md:text-lg">Đỗ Trần Tuấn Anh</h3>
                  </a>
                  <p className="text-sm max-md:text-xs font-medium leading-[1.5] mb-6 max-md:mb-4">
