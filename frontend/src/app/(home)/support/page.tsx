...
export default function SupportPage() {
    return (
            ...
            <section className="hero  overflow-hidden relative max-lg:pt-150 pt-[240px] pb-[60px] z-40">
                <div className="container">
                    <div className="max-w-[948px] mx-auto text-center">
                        <p className="mb-4 font-medium uppercase">HỖ TRỢ</p>
                        <h1 className="max-lg:mb-10 mb-10">Liên hệ hỗ trợ</h1>
                        <p className="max-lg:mb-10 mb-12 max-w-[700px] mx-auto">Gọi tổng đài chăm sóc khách hàng 0906.688.013 để được phục vụ 365 ngày/năm từ 7:00 đến 22:00.</p>
                    </div>
                </div>
            </section>
            <section className=" pb-150 relative">
                <div className="absolute left-1/2 -top-[250px] w-full h-[550px] -translate-x-1/2 bg-cover  bg-hero-gradient bg-no-repeat bg-center opacity-70 md:hidden -z-10" />
                <div className="container ">
                    <div className="relative z-10">
                        ...
                        <div className=" grid grid-cols-2 max-md:grid-cols-1 gap-8">
                            <div className="bg-white dark:bg-dark-200 shadow-box rounded-medium p-2.5" data-aos="fade-up" data-aos-offset={200} data-aos-duration={1000} data-aos-delay={300} data-aos-once="true">
        ...
        38.3086 9.89256C38.3086 21.8246 21.8789 38.2653 9.94143 38.2653L9.93362 38.32Z" fill="none" className="fill-paragraph dark:fill-white" />
                                    </svg>
                                    <h3 className="mb-2.5">Đường dây nóng</h3>
                                    <a href="tel:+84906688013">+84-90-668-8013</a>
                                </div>
                            </div>
                        </div>
                    </div>
