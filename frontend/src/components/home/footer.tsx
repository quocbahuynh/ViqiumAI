            ...
            <div className="container">
                <div className="grid grid-cols-12 mb-20 max-lg:gap-y-10 max-lg:text-center">
                    <div className="col-span-12 lg:col-span-6">
                        <Image src="/images/logo.svg" alt="logo" width={120} height={40} className="inline-block dark:hidden mb-10" />
                        <Image src="/images/logo-light.svg" alt="logo dark version" width={120} height={40} className="hidden dark:inline-block mb-10" />
                        <p className="max-w-[350px] max-lg:mx-auto">
                            AI trình diễn kỹ năng bán hàng đỉnh cao dành cho Fanpage bán hàng.
                        </p>
                    </div>
                    <div className="col-span-12 lg:col-span-2 max-lg:text-center">
                        <h3 className="mb-8 font-medium text-lg">Khám phá</h3>
                    ...
                    <div className="col-span-12 lg:col-span-2 max-lg:text-center">
                        <h3 className="mb-8 font-medium text-lg">Mạng xã hội</h3>
                        <ul className="[&>*:not(:last-child)]:mb-3">
                            <li>
                                <Link href="banking.html" className="relative inline-block overflow-hidden text-base capitalize text-paragraph dark:text-white before:absolute before:bottom-0 before:left-0 before:h-[1px] before:w-full before:origin-right before:scale-x-0 before:bg-paragraph dark:before:bg-white  before:transition-transform before:duration-500 before:content-[''] before:hover:origin-left before:hover:scale-x-100">
                                    Facebook
                                </Link>
                            </li>
                            <li>
                                <Link href="team.html" className="relative inline-block overflow-hidden text-base capitalize text-paragraph dark:text-white before:absolute before:bottom-0 before:left-0 before:h-[1px] before:w-full before:origin-right before:scale-x-0 before:bg-paragraph dark:before:bg-white  before:transition-transform before:duration-500 before:content-[''] before:hover:origin-left before:hover:scale-x-100">
                                    X (Twitter)
                                </Link>
                            </li>
                            <li>
                    ...
                    <div className="col-span-12 lg:col-span-2 max-lg:text-center">
                        <h3 className="mb-8 font-medium text-lg">Liên hệ </h3>
                        <p className="mb-3">
                            <Link href="mailto:hi.viqium@gmail.com" className="relative inline-block overflow-hidden text-base capitalize text-paragraph dark:text-white before:absolute before:bottom-0 before:left-0 before:h-[1px] before:w-full before:origin-right before:scale-x-0 before:bg-paragraph dark:before:bg-white  before:transition-transform before:duration-500 before:content-[''] before:hover:origin-left before:hover:scale-x-100">
                                hi.viqium@gmail.com
                            </Link>
                        </p>
                        <p className="mb-3">
                            <Link href="tel:+84906688013" className="relative inline-block overflow-hidden text-base capitalize text-paragraph dark:text-white before:absolute before:bottom-0 before:left-0 before:h-[1px] before:w-full before:origin-right before:scale-x-0 before:bg-paragraph dark:before:bg-white  before:transition-transform before:duration-500 before:content-[''] before:hover:origin-left before:hover:scale-x-100">
                                +84-90-668-8013
                            </Link>
                        </p>
                        <ul className="flex items-center max-lg:justify-center social-link gap-4">
                            <li>
                                <Link href="#" className="transiton-all">
                                    <svg xmlns="http://www.w3.org/2000/svg" width={28} height={28} viewBox="0 0 28 28" fill="none">
                                        <path d="M26.25 14.0749C26.25 7.26802 20.7655 1.75 14 1.75C7.23451 1.75 1.75 7.26802 1.75 14.0749C1.75 20.2265 6.22962 25.3254 12.0859 26.25V17.6375H8.97559V14.0749H12.0859V11.3595C12.0859 8.27062 13.9148 6.5644 16.7129 6.5644C18.0528 6.5644 19.4551 6.80512 19.4551 6.80512V9.83819H17.9104C16.3888 9.83819 15.9141 10.7883 15.9141 11.764V14.0749H19.3115L18.7684 17.6375H15.9141V26.25C21.7704 25.3254 26.25 20.2265 26.25 14.0749Z" fill="none" className="fill-paragraph dark:fill-gray-100 hover:fill-primary dark:hover:fill-primary" />
                                    </svg>
                                </Link>
                            </li>
                            <li>
                ...
                <div className="seperator relative w-full h-[50px] lg:h-[100px]">
                    <Image src="/images/footer-seperator.svg" alt="footer-seperator" fill className="dark:hidden object-cover" />
                    <Image src="/images/footer-seperator-dark.svg" alt="footer-seperator" fill className="hidden dark:block object-cover" />
                </div>
                <div className="py-10 max-lg:text-center">
                    <div className="flex max-lg:flex-col lg:items-center">
                        <p className="max-lg:mb-10"><span id="date" /> Bản quyền thuộc Viqium AI</p>
                        <ul className="lg:ml-auto flex items-center gap-15  max-lg:justify-center">
                            <li>
                                <Link href="/privacy" className="relative inline-block overflow-hidden text-base capitalize text-paragraph dark:text-white before:absolute before:bottom-0 before:left-0 before:h-[1px] before:w-full before:origin-right before:scale-x-0 before:bg-paragraph dark:before:bg-white  before:transition-transform before:duration-500 before:content-[''] before:hover:origin-left before:hover:scale-x-100">
                                    Chính sách bảo mật
                                </Link>
                            </li>
                            <li>
                                <Link href="/terms-and-conditions" className="relative inline-block overflow-hidden text-base capitalize text-paragraph dark:text-white before:absolute before:bottom-0 before:left-0 before:h-[1px] before:w-full before:origin-right before:scale-x-0 before:bg-paragraph dark:before:bg-white  before:transition-transform before:duration-500 before:content-[''] before:hover:origin-left before:hover:scale-x-100">
                                    Điều khoản &amp; Dịch vụ
                                </Link>
                            </li>
                        </ul>
